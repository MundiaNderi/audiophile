    ...
    <>
      <div className="flex flex-col md:flex-row px-4 md:px-32">
        ...
        {filteredData.map((data) => (
          <div
            className="flex flex-col justify-center items-center md:justify-normal md:flex-row mt-20"
            key={data.id}
          >
            {/* Images */}
            <div className="">
      ...
      <div>
        ...
        {markOneData.map((data) => (
          <div
            key={data.id}
            className=" flex flex-col md:flex-row-reverse  mt-16 mx-4 md:mx-32 "
          >
            {/*Images */}
            <div className="">
              <img src={data.image.mobile} className="md:hidden rounded-md" />
            ...
            {/*Descriptions */}
            <div className="flex flex-col justify-center items-center md:items-start ">
              <h1 className="font-manrope py-4 font-bold text-2xl ">
                {data.name}
              </h1>
              <p className="text-center md:text-left font-manrope pb-4">
                {data.description}
              </p>
              <Link to={`/${data.category}/${data.slug}`}>
                <SeeProduct text="See Product" />
      ...
      <div>
        ...
        {whiteHeadphones.map((data) => (
          <div
            className="flex flex-col pb-16 justify-center items-center md:justify-normal md:flex-row mt-20 px-6 md:mx-32 "
            key={data.id}
          >
            {/*Images */}
            <div className="">
            ...
            {/*Descriptions */}
            <div className="flex flex-col justify-center items-center md:items-start">
              <h1 className="font-manrope text-2xl font-bold py-4 ">
                {data.name}
              </h1>
              <p className="text-center md:text-left pb-4 font-manrope ">
                {data.description}
              </p>
              <Link to={`/${data.category}/${data.slug}`}>
                <SeeProduct text="See Product" />
